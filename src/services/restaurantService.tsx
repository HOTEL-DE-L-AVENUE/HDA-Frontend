...
export const closeAllOrders = (order_ids: number[]) =>
  api.post<ApiResponse<{ closed_orders: number; hidden_from_daily_caisse: boolean }>>('/api/restaurant/orders/close-all', { order_ids }).then(res => res.data);

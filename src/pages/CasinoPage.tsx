...
const createInitialRackChecks = (): RackCheck[] => [{ id: Date.now(), date: new Date().toISOString().slice(0, 10), time: getCurrentTime(), type: 'Contrôle', expected: 0, actual: '', missing: '', verified: false, variance: '' }];

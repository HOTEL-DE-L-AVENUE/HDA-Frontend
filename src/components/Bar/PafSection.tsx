...
export const PafSection: React.FC = () => {
  ...
  const loadData = async () => {
    ...
    setError(null);
    try {
      const [current, closureRows] = await Promise.all([getPafCurrent(), getPafClosures()]);

...
const navItems: NavItem[] = [
  ...
  { id: 'bar', label: 'Bar & Lounge', icon: <Wine size={20} />, gradient: 'from-accent to-accent-2', path: "/bar", roles: ['admin', 'manager', 'water', 'barman', 'receptioniste', 'caissier', 'caisse', 'stock_manager'] },
